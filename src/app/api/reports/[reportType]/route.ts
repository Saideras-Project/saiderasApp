...
async function getDetailedOrdersReport(from: Date, to: Date) {
  ...
  return orders.map((order) => {
    ...
    return {
      ...
      subtotal: Prisma.Decimal.sub(order.total || new Prisma.Decimal(0), order.tip || new Prisma.Decimal(0)),
      discount: order.discount || new Prisma.Decimal(0),
      tip: order.tip || new Prisma.Decimal(0),
      total: order.total || new Prisma.Decimal(0),
